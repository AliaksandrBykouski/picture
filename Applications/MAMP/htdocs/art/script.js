...
console.log("postData:", _services_requests__WEBPACK_IMPORTED_MODULE_0__.postData);
const forms = () => {
...
const modals = () => {
  ...
  function openModalByScroll(selector) {
    window.addEventListener('scroll', () => {
      if (!btnReset && window.scrollY + document.documentElement.clientHeight >= document.documentElement.scrollHeight) {
